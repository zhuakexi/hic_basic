...
from .hicio import get_ref_dir, load_json, parse_gtf, parse_bed
...
class Feature(ABC):
    ...
    def __init__(self, genome_name, feature_name, file_type="bed", db_dir=None):
        """
        ...
        self.fn = self.db_dir / f"{self.genome_name}.{self.feature_name}.{file_suffix}"
    @property
    def data(self):
        """
