...
def test_gen_adata_fullinput(request, tmp_path):
    ...
    #adata = gen_adata(qc, cache_dir, expr = None, velo = velo_files, g1 = g1_files, g2 = g2_files, cdps=None, rs=None, pm=None, g1cs = "/shareb/ychi/repo/embryo_integrate/CompartmentStrength/cs/", g2cs = "/shareb/ychi/repo/embryo_integrate/CompartmentStrength/cs/")
